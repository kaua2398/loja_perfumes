// noir.js - Funções específicas da página noir.html
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function addToCart() {
        let cart = JSON.parse(localStorage.getItem('auraCart')) || [];
        const product = { id: 2, name: 'Noir', price: 95.50, image: 'imagme/noir.png', quantity: 1 };
    ...
    function addToFav() {
        let favs = JSON.parse(localStorage.getItem('auraFavorites')) || [];
        const product = { id: 2, name: 'Noir', price: 95.50, image: 'imagme/noir.png' };
